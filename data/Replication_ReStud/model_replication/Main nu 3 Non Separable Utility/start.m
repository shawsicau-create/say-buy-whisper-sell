...
p.alpha      = 0.607805;
p.R          = 0.010105;
p.phi        = 0.863468;                          % productivity non-market
p.F0m        = 0.061876;                          % fixed cost of refinancing
p.B          = 10.679463;                         % bequest motive
p.r1         = 0.381189; 
p.r2         = 12.73997; 
p.rh         = (1 + 0.017843)^(1/4) - 1;          % upper bound on liquid rate
...
cmaxh        = bisect('savings', 1e-13, 1e5, swh, p, 'h', amin);                 % c that implies a' = amin
cmaxr        = bisect('savings', 1e-13, 1e5, swr, p, 'r', amin); 

cminh        = bisect('savings', 1e-13, 1e5, swh, p, 'h', amax);                 % c that implies a' = amax
cminr        = bisect('savings', 1e-13, 1e5, swr, p, 'r', amax);  
