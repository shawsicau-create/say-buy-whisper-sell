...
p.alpha      = 0.985853;
p.R          = 0.015042;
p.phi        = 0.898746;                          % productivity non-market
p.F0m        = 0.070863;                          % fixed cost of refinancing
p.B          = 9.539658;                         % bequest motive
p.r1         = 0.345363; 
p.r2         = 11.435834; 
p.rh         = (1 + 0.029779)^(1/4) - 1;          % upper bound on liquid rate
...
p.rm         = (1 + 0.0417)^(1/4) - 1;            % mortgage interest rate
