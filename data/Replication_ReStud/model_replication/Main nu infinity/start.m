...
p.alpha      = 0.684551;
p.R          = 0.011378;
p.phi        = 0.880560;                          % productivity non-market
p.F0m        = 0.277895;                          % fixed cost of refinancing
p.B          = 10.526430;                         % bequest motive
p.r1         = 0.273172; 
p.r2         = 8.911947; 
p.rh         = (1 + 0.018440)^(1/4) - 1;          % upper bound on liquid rate
