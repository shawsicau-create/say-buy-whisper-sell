...
A(:, 1)  = p.A0;               % they all start with some initial wealth
...
moment_model(74)      = mean(vec(W(:, date + 1)))/mean(vec(W(:)));  % average wealth 25-30 to average wealth overall


moment_data = [0.64; 1.45; 1.82; 0.83; 0.46;  0.07; 0.53; 0.15; 0.26; 0.41; 0.20; 0.32; 0.15; 0.23; 2.00; 0.22; 0.044; 0.71; 0.24; 0.11;
              -0.04;    0; 0.07; 0.48; 1.50; -0.05;    0; 0.01; 0.15; 1;   -0.04; 0.01; 0.15; 0.68; 1.69;   
               ...
               0.09; 0.21; 0.34; 1.39; 0.04;  0.16; 0.03; 0.18; 0.46];
...
fprintf('Average Wealth 25-30 to average wealth all         = %9.2f %9.2f\n',  [moment_model(74),   moment_data(74)]);
...
if exist('x', 'var')
    ...
    fprintf('%5.6f  %5.6f  %5.6f  %5.6f  %5.6f  %5.6f  %5.6f %5.6f %5.6f %5.6f %5.6f \n',  [x(:)', err_mom]);
