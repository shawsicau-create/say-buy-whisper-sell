...
p.alpha      = 0.676875;
p.R          = 0.010609;
p.phi        = 0.992117;                          % productivity non-market
p.F0m        = 0.099278;                          % fixed cost of refinancing
p.B          = 10.283737;                         % bequest motive
p.r1         = 0.354899; 
p.r2         = 10.045145; 
p.rh         = (1 + 0.015714)^(1/4) - 1;          % upper bound on liquid rate
p.A0         = 5.119949; 
...
%p.rl           = ((1 + p.rl)^4 - dR)^(1/4) - 1; 
%p.rh           = ((1 + p.rh)^4 - dR)^(1/4) - 1;  
