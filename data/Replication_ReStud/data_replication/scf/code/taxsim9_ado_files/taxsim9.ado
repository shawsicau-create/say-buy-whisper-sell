...
*/
display "begin taxsim9.ado on $S_DATE (version 9.10)"
...
scalar startobs = _N
scalar obs0=_N
quietly drop if year<1960 | year>2023 | year==. 
...
quietly drop if (year<1977|year>2016) & state !=0
...
quietly drop if agex<0 | agex>12000
drop_message obs0-_N agex
quietly drop if depchild<0|depchild>999999
...
#delimit cr
scalar obs0=_N
foreach X in `positive_items' swage pwage {
