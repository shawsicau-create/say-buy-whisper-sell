...
******************************
*Drop observation with wealth below 80th percentile
******************************
...
replace res = round(res, 1000)+3000     
...
outsheet using "`output'/tab1_richest20%.csv", replace c
